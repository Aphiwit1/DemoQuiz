...
<div class="container">
    <div class="row mb-2">
        <div class="col-md-3">
            ...
            <div class="col-md-9">
            <a href="" class="btn btn-success float-right">Add User</a>
            </div>   
    </div>
    ...
    <div class="row">
            <table class="table table-bordered">
                <tr>
                    ...
                    <th style="width:50px;">Subject Id</th>
                ...
                <tbody>
                    ...
                    <td style="font-size: 0.8em;">{{$user->marked}}</td>
                    <td style="font-size: 0.8em;">{{$user->firstname}}</td>
                    <td style="font-size: 0.8em;">{{$user->lastname}}</td>
                    <td style="font-size: 0.8em;">{{$user->subject_id}}</td>
                    <td style="font-size: 0.8em;">{{$user->subject_name}}</td>
                    <td style="font-size: 0.8em;">{{$user->subject_id}}</td>
                    <td >
